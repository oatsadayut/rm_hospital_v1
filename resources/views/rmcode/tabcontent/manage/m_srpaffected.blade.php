...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center px-3 pb-3 pt-3 mb-3 border-bottom bg-white">
    <span>HOME > ตั้งค่ารหัสความเสี่ยง > จัดการรหัสส่งออก ผู้ได้รับผลกระทบ</span>
</div>
                    ...
                    <div class="modal fade" id="modaladdsrpaffected" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{route('rmaddsrpaffected')}}">
                                    @csrf
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="affected_srp_name">ชื่อ</label>
                                                    <input type="text" class="form-control" id="affected_srp_name" name="affected_srp_name" placeholder="กรุณากรอก ชื่อ" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="affected_export_code">รหัสส่งออก</label>
                                                    <input type="text" class="form-control" id="affected_export_code" name="affected_export_code" placeholder="กรุณากรอก รหัสส่งออก" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                ...
                                @foreach ($affected_srp as $r)
                                    <tr>
                                        ...
                                        <td class=" text-center bg-secondary">
                                            <a href="{{action('RmcodeController@frmsrpaffected',$r->affected_srp_id)}}" class=" btn btn-warning btn-sm">แก้ไข</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
