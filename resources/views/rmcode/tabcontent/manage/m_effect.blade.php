...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center px-3 pb-3 pt-3 mb-3 border-bottom bg-white">
    <span>HOME > ตั้งค่ารหัสความเสี่ยง > จัดการผลกระทบ</span>
</div>
                ...
                <div class="card-body">
                    ...
                    <div class=" row">
                        ...
                        <div class="col-md-6 text-right">
                            <button type="button" data-toggle="modal" data-target="#modaladdeffect" class=" btn btn-success btn-sm"><i class="fas fa-plus"></i> เพิ่มข้อมูล</button>
                    ...
                    <hr>
                    <div>
                        <table id="tebal-setting18" class="table table-sm table-hover">
                            ...
                            <tbody>
                                @foreach ($effect as $r)
                                    <tr>
                                        ...
                                        <a href="{{action('RmcodeController@frmeffect',$r->effect_code)}}" class=" btn btn-warning btn-sm">แก้ไข</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
