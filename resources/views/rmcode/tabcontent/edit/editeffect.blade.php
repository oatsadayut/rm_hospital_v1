...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center px-3 pb-3 pt-3 mb-3 border-bottom bg-white">
    <span>HOME > ตั้งค่ารหัสความเสี่ยง > จัดการผลกระทบ > แก้ไขผลกระทบ</span>
</div>
...
>>>>>>> 80a11cda8d22f017e890ae5582d63472df11c23e
                    <form method="POST" action="{{route('rmediteffect')}}">
                        @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 px-5 pt-1">
                                    <div class="form-group">
                                        <label for="effect_name" class=" h5">ชื่อ</label>
                                        <input type="text" placeholder="กรุณากรอก ชื่อผลกระทบ" value="{{$qe->effect_name}}" name="effect_name" class=" form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 px-5 py-2">
                                    <input type="hidden" name="code" value="{{$qe->effect_code}}">
                                    <button type="summit" id="btn-submit" name="btn-submit" class="btn btn-primary">ยืนยัน</button>
                                    <a href="/rmcode/manage/effect" class="btn btn-secondary">ย้อนกลับ</a>
                                </div>
                            </div>
                    </form>
                </div>
