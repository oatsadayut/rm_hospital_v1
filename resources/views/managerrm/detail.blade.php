                    ...
                    <div class="form-row mb-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="rm_date_review" value="{{$q->rm_date_review}}" name="rm_date_review" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="sel-22" name="rm_review" class="form-control" required>
                                    ...
                                    <option value="{{$r->system_code}}" {{($r->system_code == $q->system_code) ? "selected" : ""}}>{{$r->system_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="rm_results_review" class=" form-control" rows="7"  id="rm_results_review" placeholder=" กรุณากรอก ผลการทบทวน" required>{{$q->rm_results_review}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="modalcancelrm" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="form-row mb-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="log_detail" class=" form-control" rows="7"  id="log_detail" placeholder=" กรุณากรอก เหตุผลการยกเลิก" required></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class=" row">
                        ...
                        <div class="col-md-6 text-right">
                            <h4><div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{action('PrintrmController@printrm',$q->rmmain_id)}}" target="_blank" class="btn btn-primary"><i class="fas fa-file-pdf"></i> Print PDF</a>
                                <button type="button" class="btn btn-success"  data-toggle="modal" data-target="#exampleModalScrollable"><i class="fas fa-check-circle"></i> ทบทวน</button>
                                <a href="{{action('ManagerrmController@frmupdate',$q->rmmain_id)}}" class="btn btn-warning"><i class="fas fa-edit"></i> แก้ไขความเสี่ยง</a>
                                <button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#modalcancelrm"><i class="fas fa-times-circle"></i> ยกเลิกความเสี่ยง</button>
                              </div>
                            </h4>
                        </div>
                        <hr>
                    ...
                    <div class=" row bg-detail-rm p-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <h5><span class=" text-secondary"> วัน/เวลา ที่เกิดเหตุ :</span> {{$q->rmmain_dateon}} {{$q->rmmain_time}} {{$q->rm_part_time}}</h5>
                ...
                <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="code-rm" data-toggle="tab" href="#code" role="tab" aria-controls="code-rm" aria-selected="true"><h5 class=" text-secondary"><i class="fas fa-shield-alt text-warningb"></i> รหัสความเสี่ยง</h5> </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="position-rm" data-toggle="tab" href="#position" role="tab" aria-controls="position-rm" aria-selected="false"><h5 class=" text-secondary"><i class="fas fa-clinic-medical text-success"></i> หน่วยงานที่เกี่ยว</h5></a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="committee-rm" data-toggle="tab" href="#committtee" role="tab" aria-controls="committee-rm" aria-selected="false"><h5 class=" text-secondary"><i class="fas fa-user-md text-info"></i> กรรมการที่เกี่ยวข้อง</h5></a>
                            </li>
                        </ul>
